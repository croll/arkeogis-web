            ...
            $scope.$watchCollection('params.database', function() {
                ...
                $scope.params.database.forEach(function(database_id) {
                    ...
                    */
                    ...
                    switch (db.type) {
                        case 'inventory':
                            type_tr = 'MAP.MENU_DATABASE.T_INVENTORY';
                            break;
                        case 'research':
                            type_tr = 'MAP.MENU_DATABASE.T_RESEARCH';
                            break;
                        case 'literary-work':
                            type_tr = 'MAP.MENU_DATABASE.T_LITERARYWORK';
                            break;
                    }
                ...
                $mdDialog.show({
                        controller: function($scope, $mdDialog, arkeoService) {
                            ...
                            $scope.$watchCollection('selected_databases', function() {
                                params.database = $scope.selected_databases.map(function(elem) {
                                    return elem.id
                                });
                            });
            ...
            function showChronologyChooserDialog(params) {
                $mdDialog.show({
                        controller: function($scope, $mdDialog, arkeoService) {
                            ...
                            $scope.selection = [{
                                content: $scope.chronologies
                            }, $scope.chronologies[0], null, null, null];
